...
FROM transactions t2 
  WHERE t2.transaction_date BETWEEN t1.transaction_date AND DATE_ADD(t1.transaction_date, INTERVAL 6 DAY)) AS rolling_tpv_7, (
...
FROM transactions t2 
  WHERE t2.transaction_date BETWEEN t1.transaction_date AND DATE_ADD(t1.transaction_date, INTERVAL 6 DAY)) AS active_customers_7
